...
for (const localRuntime of [
  "./vendor/pako.min.js?v=12",
  "./vendor/sql-wasm.js?v=12",
  "./vendor/apexcharts.min.js?v=12",
]) {
...
if (!serviceWorker.includes("bist-picker-shell-v12")) {
  throw new Error("Service worker cache version was not bumped to v12.");
}
...
if (!appJs.includes("./vendor/${filename}?v=12")) {
  throw new Error("sql.js WASM locateFile cache version was not bumped to v12.");
}
