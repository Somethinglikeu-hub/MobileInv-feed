...
if (!serviceWorker.includes("bist-picker-shell-v11")) {
  throw new Error("Service worker cache version was not bumped to v11.");
}
...
if (!appJs.includes("./vendor/${filename}?v=11")) {
  throw new Error("sql.js WASM locateFile cache version was not bumped to v11.");
}
